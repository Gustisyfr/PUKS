...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="/mitra/daftarks/save" method="post">
                <?= csrf_field(); ?>
                <!-- nama mitra -->
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-danger mb-3" onclick="window.location.href='<?= base_url('pages/mitra/home') ?>';">Kembali</button>
                </div>
