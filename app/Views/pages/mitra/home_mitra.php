...
<!-- carousel -->
    ...
    <div class="card-container">
        <div class="progress progress-custom" role="progressbar" aria-label="Success example" aria-valuenow="<?= $progress ?>" aria-valuemin="0" aria-valuemax="100">
            <div class="progress-bar bg-primary" style="width: <?= $progress ?>%"><?= $progress ?>%</div>
        </div>
        <p class="text-center mt-3" style="color: aliceblue;">
            <?php if ($progress == 25): ?>
                Status: Sudah Mendaftar
            <?php elseif ($progress == 50): ?>
                Status: Verifikasi Mitra Selesai
            <?php elseif ($progress == 75): ?>
                Status: Verifikasi Dokumen Selesai
