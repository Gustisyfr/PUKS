            ...
            <tbody class="table-light">
                ...
                <td> 
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn me-auto btn-success" alt="Edit" onclick="window.location.href='<?= base_url('admin/uploadmemo/'.$r['id']); ?>';">
                        ...
                        <form action="statusr/<?= $r['id']; ?>" method="post">
                            <?= csrf_field(); ?>
