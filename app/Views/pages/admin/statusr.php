            ...
            <tbody class="table-light">
                ...
                <td> 
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn me-auto btn-success" alt="Edit" onclick="window.location.href='<?= base_url('pages/admin/uploadmemo/'.$r['id']); ?>';">
                        ...
                        <form action="/admin/statusr/<?= $r['id']; ?>" method="post">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="DELETE">
                            <button type="submit" class="btn me-auto btn-danger" alt="hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');" >
