...
<div class="container">
    <div class="row">
        <div class="col">
            <h2 class="my-3">Status Verifikasi Dokumen</h2>
            ...
            <tbody class="table-light">
                ...
                <td><?= $vd['uraian']; ?></td>
                <td> 
                    <button type="button" class="btn me-auto" onclick="window.location.href='<?= base_url('pages/ses/verifikasidok/'.$vd['id']); ?>';">
