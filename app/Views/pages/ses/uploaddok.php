...
<script>
    ...
    if (this.value === 'Kementrian/Lembaga' || this.value === 'Pemerintah Daerah' || this.value === 'Badan Usaha Milik Negara' || this.value === 'Universitas/Perguruan Tinggi' || this.value === 'Swasta' || this.value === 'Organisai Masyarakat/Lembaga Swadaya Masyarakat') {
        ...
        if (this.value === 'Kementrian/Lembaga' || this.value === 'Pemerintah Daerah' || this.value === 'Badan Usaha Milik Negara') {
        } else if (this.value === 'Universitas/Perguruan Tinggi') {
            document.getElementById('profilMitraInput').style.display = 'block';
        } else if (this.value === 'Swasta' || this.value === 'Organisai Masyarakat/Lembaga Swadaya Masyarakat') {
            document.getElementById('profilMitraInput').style.display = 'block';
