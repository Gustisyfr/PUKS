...
class Statusvd extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('/pages/admin/statusvd', $data);
    ...
    public function verify($id)
    {
        ...
        return redirect()->to('/admin/statusvd')->with('success', 'Dokumen berhasil diverifikasi.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/admin/statusvd')->with('message', 'Data berhasil dihapus');
    }
